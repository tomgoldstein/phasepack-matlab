...
% This test file implements the SketchyCGMsolver. The code builds
...
%
% PAPER TITLE:
%              Sketchy Decisions: Convex Low-Rank Matrix Optimization with
%              Optimal Storage.

% ARXIV LINK:
%              https://arxiv.org/abs/1702.06838
...
opts.algorithm = 'sketchyCGM';
opts.isComplex = isComplex;
opts.maxIters = 1000;
opts.tol = 1e-3;  % Because SketchyCGM is a sub-gradient method, it is difficult to achieve a very small tolerance
opts.verbose = 2;
