%%                   testReweightedWirtFlow.m

% This test file implements the Reweighted Wirtinger Flow solver. The code
...
% ARXIV LINK:
%              https://arxiv.org/pdf/1612.09066.pdf
...
n = 200;          % Dimension of unknown vector
...
% Options
opts = struct;
opts.initMethod = 'weightedspectral';
opts.algorithm = 'RWF';
